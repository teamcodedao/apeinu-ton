    ...
    <div className='min-h-screen'>
      <div
        className={clsx(
          ...
          'max-[720px]:multi-["sticky;top-0;z-50;bg-primary"]'
        )}
      >
        <header
          className={clsx(
        ...
        >
          ...
          <div className='mixin/hamburger -translate-x-1 -translate-y-1 self-baseline'>
            <Hamburger />
          </div>
          <a
            ...
            target='_buy'
            className={clsx(
              'inline-block shrink-0 rounded-full border-[3px] border-black bg-primary px-4 py-1 text-2xl font-bold text-secondary transition btn-shadow md:px-5 md:py-1.5',
